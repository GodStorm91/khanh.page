<?php $__env->startSection('body'); ?>
    <?php $__currentLoopData = $posts->where('featured', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featuredPost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="w-full mb-6">
            ...
            <h2 class="text-3xl mt-0">
                <a href="<?php echo e($featuredPost->getUrl()); ?>" title="Read <?php echo e($featuredPost->title); ?>" class="text-black font-extrabold">
    ...
    <?php echo $__env->make('_components.newsletter-signup', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
